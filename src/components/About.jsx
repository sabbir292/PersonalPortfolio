      ...
      <div className="container mx-auto">
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          className='flex-1'>
            ...
            <p className='mb-6'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas, praesentium et dolor architecto similique
            </p>
            {/* stats */}
            ...
            <div className='flex gap-x-8 items-center'>
              ...
              <a className='text-gradient btn-link' href="contact">My Portfolio</a>
            </div>
          </motion.div>
        </div>
      </div>
